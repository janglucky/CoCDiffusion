...
SEESR_MODEL_PATH="${SEESR_MODEL_PATH:-experiment/deblur_train_c_sub/checkpoint-36000}"
IMAGE_PATH="${IMAGE_PATH:-/home/gd09385/data/test_c/source}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/gd09385/work/CoCDiffusion/experiment/deblur_test_ddim-36000}"
